...
for i in range(num_games):
    print("Loop Number:", i)
    # Randomly choose what color the agent should be
    if i < num_games//2:
        agentColor = colors[0]
    else:
        agentColor = colors[1]
...
print("White Policy use Percentage: ", (WHITE_policy_used/WHITE_actions_taken)*100)
print("--------")
print("Number of Games as Black: ", BLACK_num_games)
print("Number of wins: ", BLACK_wins)
print("Number of ties: ", BLACK_ties)
print("Black Policy use Percentage: ", (BLACK_policy_used/BLACK_actions_taken)*100)