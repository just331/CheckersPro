# This program has been modified to train ONLY the black policy
...
for x in range(num_saves):
    ...
    #     print("Normal Start")
    type_Episode = type_Episodes[0]  # Make all games normal for this testing
    ...
    for i in range(num_Episodes_per_Save):
        ...
        agentColor = colors[1]  # Always black for this testing
...
print("Saving")
# --- Save values ---
# joblib.dump(WHITE_returns, 'Pickles/WHITE_returns_exp.sav')
#
# joblib.dump(WHITE_v, 'Pickles/WHITE_v_exp.sav')
# ----
joblib.dump(BLACK_returns, 'Pickles/BLACK_returns_exp.sav')

joblib.dump(BLACK_v, 'Pickles/BLACK_v_exp.sav')
# --------------------------
